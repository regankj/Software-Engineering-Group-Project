...
def open_homepage(root):
    ...
    # Questions button
    q_btn = Button(frame_btns, text="Question Bank", padx=32, pady=22, font = large_btn_font, background = btn_background, command = lambda: login(select_q_type))
    # Create Quiz button
    create_btn = Button(frame_btns, text="Create a Quiz", padx=41, pady=22, font = large_btn_font, background = btn_background, command = lambda: login(select_create_type))
    # Start quiz button
    start_btn = Button(frame_btns, text="Start a Quiz", padx=53, pady=23, font = large_btn_font, background = btn_background, command = select_quiz_type)
    # Statistics button
    stats_btn= Button(frame_btns, text="View Statistics", padx=30, pady=23, font = large_btn_font, background = btn_background, command = lambda: login(select_stats_type))
