...
def enter_mc(window):
    ...
    add_question = Button(window, text="Submit", font=("Gill Sans", 12, "bold"), background="green", command=add)
    ...
    qbank_info ="Welcome to the question bank! To add\n" \
                "a question, fill in all entry fields\n" \
                "and then click 'Submit'. To edit or \n" \
                "delete a question, enter the question\n" \
                "ID into the ID entry box and click\n" \
                "'Edit/View' to edit, or 'Delete' to\n" \
                "delete the question."


    info_lbl = Label(window, text=qbank_info, background='#ffffff', font=("Gill Sans", 12, 'bold'))
    info_lbl.grid(row=11, column=1,pady=5)
